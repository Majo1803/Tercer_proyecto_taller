    ...
    def iniciar_act(self, nombre,cont_analizador,cont):
        ...
        while aux!=None:
            if aux.nombre == nombre: #si el nombre recibido es igual al de una actividad registrada
                ...
                s1=schedule.every(30).seconds.do(analizador_emociones_imagen,cont_analizador,final) #son 30 segundos, porque la cuenta regresiva en la función cuenta los otros 30 segundos, completando el minuto         
                while True:
